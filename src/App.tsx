                ...
                <div className="relative w-72 h-72 md:w-96 md:h-96 animate-float">
                  ...
                  <div className="w-full h-full rounded-full border-4 border-gray-800 shadow-2xl bg-gray-800 relative z-10 ring-4 ring-amber-500/30 overflow-hidden flex items-center justify-center">
                    <div className="w-full h-full rounded-full overflow-hidden">
                     <img src="https://i.ibb.co/VWCdmFf6/KHALID.jpg" alt="Prof. Khaled Osman" className="w-full h-full object-cover rounded-full transform hover:scale-110 transition duration-700" loading="eager" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Reveal className="w-full">
                <Tilt3D className="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-gray-700 shadow-2xl relative overflow-hidden text-start">
                   ...
                   <a href="https://scholar.google.com.eg/citations?user=9CRT1QoAAAAJ&hl=en" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-amber-500 font-semibold hover:text-gray-100 transition-colors group">
                    ...
                    {content.certifications.items.map((cert, idx) => (
                      <Reveal key={idx} className="h-full">
                        <Tilt3D className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-amber-500 transition flex flex-col h-full group text-start">
                            ...
                            <a href={cert.link} target="_blank" rel="noreferrer" className="mt-auto text-xs font-semibold text-amber-500 hover:text-gray-100 flex items-center gap-1 transition">Verify Academic Info <ExternalLink /></a>
                        </Tilt3D>
                      </Reveal>
                    ))}
                </div>
        ...
        <section id="projects" className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                     ...
                     <Tilt3D className="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden hover:shadow-[0_10px_30px_-10px_rgba(245,158,11,0.3)] hover:scale-105 hover:border-amber-500/50 relative transition-all duration-300 flex flex-col group h-full text-start">
                        ...
                        <div className="p-6 flex flex-col flex-grow relative">
                          ...
                          <div className="flex flex-wrap gap-3 mt-auto">
                            {project.demoLink && <a href={project.demoLink} target="_blank" rel="noreferrer" className="flex-1 text-center py-2 rounded-lg bg-amber-500 text-gray-900 font-semibold text-sm hover:bg-amber-400 transition shadow-lg btn">Scholar</a>}
                            {project.doiLink && (
                              <a href={`https://doi.org/${project.doiLink}`} target="_blank" rel="noreferrer" className="flex-1 text-center py-2 rounded-lg border border-gray-600 text-gray-100 font-semibold text-sm hover:border-amber-500 hover:text-amber-500 transition btn">DOI</a>
                            )}
                          </div>
                        </div>
                     </Tilt3D>
              ...
              <div className="text-center mt-12">
                <a href="https://scholar.google.com.eg/citations?user=9CRT1QoAAAAJ&hl=en" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-gray-400 hover:text-amber-500 transition-colors font-semibold">
